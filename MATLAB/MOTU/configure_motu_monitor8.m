...
webwrite(baseURL + "ext/obank/17/ch/0/src", 'json={"value":"3:2"}'); % Caregiver In to In 1
webwrite(baseURL + "ext/obank/17/ch/1/src", 'json={"value":"3:3"}'); % Waver In to In 2
webwrite(baseURL + "ext/obank/17/ch/2/src", 'json={"value":"3:5"}'); % Mic In to In 3
webwrite(baseURL + "ext/obank/17/ch/3/src", 'json={"value":"3:4"}'); % Participant In to In 4
webwrite(baseURL + "ext/obank/17/ch/4/src", 'json={"value":"3:0"}'); % Video 1 to In 4

% Connect mixer outputs to analog outputs
webwrite(baseURL + "ext/obank/2/ch/0/src", 'json={"value":"16:0"}');
webwrite(baseURL + "ext/obank/2/ch/1/src", 'json={"value":"16:0"}');
webwrite(baseURL + "ext/obank/3/ch/0/src", 'json={"value":"16:1"}');
webwrite(baseURL + "ext/obank/3/ch/1/src", 'json={"value":"16:1"}');
webwrite(baseURL + "ext/obank/4/ch/0/src", 'json={"value":"16:2"}');
