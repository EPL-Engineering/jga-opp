        ...
        for param,units,convFactor in nostepParams:
            if convFactor == 'CHECKBOX':
                ...
                if not varStimFirst['nostep'].has_key(param):
                    WarnDlg(self.frame, 'Missing value for "'+param+'". I will set it to 0. Please check it.')
                ...
                if not varStimFirst['nostep'].has_key(param):
                    WarnDlg(self.frame, 'Missing value for "'+param+'". I will set it to blank. Please check it.')
