...
##            return
        ...
        if 'nStoppingOption' in self.var:
            for i in range(3):
                if self.rbStopOption[i].GetValue():
                    self.var['nStoppingOption'] = i
                    break
        if 'nStoppingOption2' in self.var:
            for i in range(3):
